...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      statusMessage.textContent = message.loading; //form.append(statusMessage);
...
function slider(_ref) {
  ...
  var indication = document.createElement('ol'),
      dots = [];
  ...
  next.addEventListener('click', function () {
    ...
    sliderField.style.transform = "translateX(-".concat(offset, "px)");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  }, 300000); // Изменил значение, чтобы не отвлекало
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2020-09-30');
